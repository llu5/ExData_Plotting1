...
filtered_data_m <- rename(filtered_data_m, dish_washer_oven = Sub_metering_1,
                          washer_fridge_light= Sub_metering_2, heater_HVAC = Sub_metering_3)  ## rename three sub metering columns in a more meaningful description
png("plot2.png", width = 480, height=480, res=78)



plot(filtered_data_m$Date_Time, filtered_data_m$Global_active_power, type = "l",
